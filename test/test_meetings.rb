...
class MeetingsTest < Test::Unit::TestCase
  ...
  context "attributes" do
    ...
    should "generate valid start meeting" do
      FakeWeb.register_uri(:get, "https://api.citrixonline.com/G2M/rest/meetings/12345/start", :body => '{"hostURL":"https://downloadstage.citrixonline.com/download.html?startMode=Join&meetingId=12345&authenticationToken=3A200"}', :content_type => "application/json", :status => ["200", "OK"])
